...
export function SiteFooter({ navigate }: { navigate: Navigate }) {
  return <footer>
    <div className="container footer-grid">
      <div><div className="logo footer-logo"><span>Điện</span> <em>24H</em><small>ĐỒNG NAI</small></div><p>Thương hiệu dịch vụ điện công nghiệp trong hệ sinh thái Công ty Cổ phần Xây lắp DOBICO.</p></div>
