  ...
  return <>
    ...
    <header>
      <div className="container nav">
        <SiteLink className="brand-logo" href="/" navigate={navigate} onNavigate={() => setOpen(false)}><img src="/logo-dien24h.png" alt="Điện 24H Đồng Nai" /></SiteLink>
...
export function SiteFooter({ navigate }: { navigate: Navigate }) {
  return <footer>
    <div className="container footer-grid">
      <div><SiteLink className="brand-logo footer-brand-logo" href="/" navigate={navigate}><img src="/logo-dien24h.png" alt="Điện 24H Đồng Nai" /></SiteLink><p>Thương hiệu dịch vụ điện công nghiệp trong hệ sinh thái Công ty Cổ phần Xây lắp DOBICO.</p></div>
